...
/**
 * Generate the official HSSort input data set.
 ...
 * <p>
 * To run the program: 
 * <b>bin/hadoop jar HSValidate.jar HSGen 10000000000 in-dir</b>
 */
public class HSGen extends Configured implements Tool {
  ...
  public static final String NUM_ROWS = "mapreduce.hssort.num-rows";
  /**
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new HSGen(), args);
    System.exit(res);
  }
}
