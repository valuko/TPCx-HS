 ...
 * <p>
 * To run the program: 
 * <b>bin/hadoop jar HSValidate.jar HSSort in-dir out-dir</b>
 */
public class HSSort extends Configured implements Tool {
  private static final Log LOG = LogFactory.getLog(HSSort.class);
  static String SIMPLE_PARTITIONER = "mapreduce.hssort.simplepartitioner";
  static String OUTPUT_REPLICATION = "mapreduce.hssort.output.replication";
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new HSSort(), args);
    System.exit(res);
  }
