 ...
 * <p>
 * To run the program: 
 * <b>bin/hadoop jar HSValidate.jar HSValidate out-dir report-dir</b>
 * <p>
 * If there is any output, something is wrong and the output of the reduce
 * will have the problem report.
 */
public class HSValidate extends Configured implements Tool {
  ...
  private static void usage() throws IOException {
    System.err.println("HSvalidate <out-dir> <report-dir>");
  }
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new HSValidate(), args);
    System.exit(res);
  }
